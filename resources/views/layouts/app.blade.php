...
<head>
    ...
    <link id="pagestyle"
        href="{{ asset('bower_components/bower_project1/css/user/material-dashboard.css?v=3.0.0') }}"
        rel="stylesheet" />
</head>
                            ...
                            <ul class="navbar-nav mx-auto">
                                <li class="nav-item dropdown pe-2 d-flex align-items-center">
                                    ...
                                    <a class="dropdown-item"
                                        href="{{ route('change-language', ['vi']) }}">{{ __('vi') }} <img
                                            src=" {{ asset('bower_components/bower_project1/img/vn.png') }}"></a>
                                    <a class="dropdown-item"
                                        href="{{ route('change-language', ['en']) }}">{{ __('en') }} <img
